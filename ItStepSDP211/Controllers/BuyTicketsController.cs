...
namespace ItStepSDP211.Controllers
{
    public class BuyTicketsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "BuyTicketsId,Email,Person,Price,Date")] BuyTickets buyTickets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "BuyTicketsId,Email,Person,Price,Date")] BuyTickets buyTickets)
        {
            if (ModelState.IsValid)
            {
